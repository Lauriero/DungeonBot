...
{
    public static IServiceCollection AddVkNet(this IServiceCollection collection)
    {
    ...
    private static IServiceCollection AddCategories(IServiceCollection collection)
    {
