...
public interface IDataStorageService
{
    ...
    /// <param name="queriesCount">Specifies how much last queries this method will return at maximum</param>
    /// <param name="token">Token to cancel the query</param>
    Task<List<MusicQueryHistoryEntity>> GetLastMusicQueries(ulong guildId, int queriesCount,
        CancellationToken token = default);
}