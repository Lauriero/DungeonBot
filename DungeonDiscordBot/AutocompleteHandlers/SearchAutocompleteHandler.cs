...
public class SearchAutocompleteHandler : AutocompleteHandler
{
    ...
    private readonly ILogger<SearchAutocompleteHandler> _logger;
    public SearchAutocompleteHandler(ILogger<SearchAutocompleteHandler> logger)
    {
        _logger = logger;
    }
        ...
        IParameterInfo parameter, IServiceProvider services)
    {
        try {
            ...
            _logger.LogError("Exception while processing search query by user {uId} in guild {gId}", 
